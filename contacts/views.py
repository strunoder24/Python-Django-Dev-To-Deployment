...
def contact(request):
    if request.method == 'POST':
        ...
        # check if user had inquary already
        ...
        # send_mail(
        #     'У вас клиент',
        #     'Был запрос на ' + listing + '. Войдите в админку чтобы увидеть подробности',
        #     'strunoder24@gmail.com',
        #     [realtor_email, 'strunoder24@yandex.ru'],
        #     fail_silently=False
        # )
